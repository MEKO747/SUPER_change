...
namespace fsm {
    class FsmRos1 : public Fsm {
        ...
        ros::Publisher cmd_pub, cmd_vel_pub_, mpc_cmd_pub_, path_pub_;
        ...
        void getOneTwistCommand(geometry_msgs::Twist &cmd_vel,
    ...
    public:
        ...
        void init(const ros::NodeHandle &nh, const std::string &cfg_path) {
            ...
            cmd_vel_pub_ = nh_.advertise<geometry_msgs::Twist>(cfg_.cmd_vel_topic, 10);
